...
print('WHITELIST_TG_CHAT_IDS: '+WHITELIST_TG_CHAT_IDS)
print('BLACKLIST_SCAM_UIDS: '+BLACKLIST_SCAM_UIDS)
print('BLACKLIST_SCAM_UNAMES: '+BLACKLIST_SCAM_UNAMES)
print('BLACKLIST_SCAM_HANDLES: '+BLACKLIST_SCAM_HANDLES)
print('BLACKLIST_SCAM_TEXT: '+BLACKLIST_SCAM_TEXT)
