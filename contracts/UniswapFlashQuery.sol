...
contract FlashBotsUniswapQuery {
    ...
    function getPairsByIndexRange(UniswapV2Factory _uniswapFactory, address _uniswapRouter, uint256 _start, uint256 _stop) external view returns (address[3][] memory, uint256[5][] memory)  {
